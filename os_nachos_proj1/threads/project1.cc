...
void latter_thread(int arg)
{
	...
	printf("Thread2 will perform calculation for %d times\n", arg*10000);
	...
	printf("The global variable in Thread2 is %d\n", global);
...
void prior_thread(int arg)
{
	...
	printf("Thread1 will perform calculation for %d times\n", arg*10000);
	...
	printf("The global variable in Thread1 is %d\n", global);
